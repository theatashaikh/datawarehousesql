...
IF OBJECT_ID('bronze.crm_orders_2023', 'U') IS NOT NULL
	DROP TABLE bronze.crm_orders_2023;
GO
...
IF OBJECT_ID('bronze.crm_orders_latest', 'U') IS NOT NULL
	DROP TABLE bronze.crm_orders_latest;
GO
